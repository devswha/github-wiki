  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "2026-07-03 v6.1.0 릴리스는 persona safety gate, ko/en/zh/ja multilingual persona, custom voice authoring, register/profile precedence, ARCHITECTURE와 WORKFLOW 문서를 묶어 persona hardening으로 정리했다.",
      ],
    },
    {
      id: "usage",
