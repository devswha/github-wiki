...
export const trendingRepositoriesArticle = {
  ...
  title: "트렌딩 저장소 조사",
  modifiedAt: "2026-07-15T01:03:02.000Z",
  categories: [
  ...
  sections: [
    {
      ...
      title: "개요",
      body: [
        "이 문서는 Github.wiki의 자동 유지보수 루프가 새 저장소 문서 후보를 고를 때 참고하는 관찰 목록이다. 실시간 순위표가 아니라, 2026-07-15 기준 GitHub 검색 결과에서 위키 주제와 맞는 저장소를 추려 둔 운영 메모에 가깝다.",
    ...
    },
    {
      ...
      body: [
        "2026-07-15에 GitHub repositories search API로 topic:ai-agent, topic:developer-tools, agentic coding 쿼리를 확인했다. 아래 저장소들은 최근 pushed 조건과 별 수 기준을 통과했고, 기존 oh-my-* / lazycodex 계열 문서와 같이 읽을 만한 후보로 보인다.",
      ],
      table: {
        ...
        rows: [
          ...
          ["daytonaio/daytona", "N/A", "AI 생성 코드 실행용 보안 인프라라는 포지션이 강하다."],
          ["anomalyco/opencode", "TypeScript", "오픈소스 코딩 에이전트 계열이라 기존 OpenCode 확장 문서와 연결된다."],
          ["rtk-ai/rtk", "Rust", "개발 명령의 LLM 토큰 사용량을 줄이는 CLI 프록시로 자동화 워크플로우와 맞닿아 있다."],
        ],
      },
      links: [
        {
    ...
    },
    {
      ...
      title: "문서화 도구 후보",
      body: [
        "문서화 축에서는 Storybook, Mermaid, Docusaurus, tldr-pages, GitBook이 반복적으로 상위권에 잡힌다. Github.wiki가 저장소 설명 위키라는 점을 고려하면, 문서 생성이나 지식 정리 경험을 비교하는 문서 후보로 쓸 수 있다.",
      ],
      table: {
        caption: "문서화 관련 후보",
        headers: ["저장소", "언어", "관찰 포인트"],
        rows: [
          ...
          ["GitbookIO/gitbook", "TypeScript", "오픈소스 문서 사이트 프론트엔드라 위키형 지식 정리와 비교하기 좋다."],
        ],
      },
      links: [
        {
