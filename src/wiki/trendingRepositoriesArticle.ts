...
export const trendingRepositoriesArticle = {
  ...
  title: "트렌딩 저장소 조사",
  modifiedAt: "2026-07-12T01:03:00.000Z",
  categories: [
  ...
  sections: [
    {
      ...
      title: "개요",
      body: [
        "이 문서는 Github.wiki의 자동 유지보수 루프가 새 저장소 문서 후보를 고를 때 참고하는 관찰 목록이다. 실시간 순위표가 아니라, 2026-07-12 기준 GitHub 검색 결과에서 위키 주제와 맞는 저장소를 추려 둔 운영 메모에 가깝다.",
    ...
    },
    {
      ...
      body: [
        "2026-07-12에 GitHub repositories search API로 topic:ai-agent, topic:developer-tools, agentic coding 쿼리를 확인했다. 아래 저장소들은 2026-07 이후 pushed 조건과 별 수 기준을 통과했고, 기존 oh-my-* / lazycodex 계열 문서와 같이 읽을 만한 후보로 보인다.",
      ],
      table: {
        ...
        rows: [
          ...
          ["rtk-ai/rtk", "Rust", "개발 명령 프록시로 LLM 토큰 사용량 절감을 전면에 내세운 CLI 도구다."],
        ],
      },
      links: [
        {
        ...
        {
          description: "developer-tools 주제에서 2026-07 이후 갱신된 대형 저장소를 확인한 검색 결과다.",
    ...
    },
    {
      ...
      table: {
        ...
        rows: [
          ...
          ["freeCodeCamp/devdocs", "Ruby", "API 문서 브라우저라 다중 문서 탐색 UX 비교 후보로 볼 수 있다."],
        ],
      },
      links: [
        {
