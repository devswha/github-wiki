...
export const lazycodexArticle = {
  ...
  infobox: [
    ...
    },
    {
      ...
      value: "v4.17.0",
      valueHref: "https://github.com/code-yeongyu/lazycodex/releases/tag/v4.17.0",
    },
    {
      label: "Links",
      links: [
  ...
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "2026-07-11 v4.17.0 릴리스는 oh-my-openagent v4.17.0에서 Codex Light marketplace payload를 동기화한 릴리스로, LazyCodex가 OmO 배포층에 가깝다는 성격을 그대로 보여 준다.",
