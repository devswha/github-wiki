...
export const ohMyOpenagentArticle = {
  ...
  infobox: [
    ...
    },
    {
      ...
      value: "v4.17.1",
      valueHref: "https://github.com/code-yeongyu/oh-my-openagent/releases/tag/v4.17.1",
    },
    { label: "Links", value: "" },
  ],
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "2026-07-13 v4.17.1 릴리스는 LazyCodex v4.17.1과 함께 게시된 패치 릴리스라, OpenAgent 본체와 Codex 배포 레포가 같은 버전 흐름으로 움직인다는 점을 보여 준다.",
