...
export const ohMyClaudecodeArticle = {
  ...
  infobox: [
    ...
    },
    {
      ...
      value: "v4.15.4",
      valueHref: "https://github.com/Yeachan-Heo/oh-my-claudecode/releases/tag/v4.15.4",
    },
    { label: "Links", value: "" },
  ],
  sections: [
    ...
    },
    {
      ...
      body: [
        ...
        "2026-07-12 v4.15.4 릴리스는 7개 bug fix와 1개 기타 변경을 묶은 패치 릴리스로 기록되어 있다. v4.15.x 흐름은 HUD, hook, learner state path 같은 안정성 수정을 계속 다듬는 쪽이다.",
