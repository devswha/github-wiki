...
export const ohMyCodexArticle = {
  ...
  infobox: [
    ...
    },
    {
      ...
      value: "v0.20.1",
      valueHref: "https://github.com/Yeachan-Heo/oh-my-codex/releases/tag/v0.20.1",
    },
    { label: "Links", value: "" },
  ],
  sections: [
    {
      ...
      body: [
        ...
        "릴리스 흐름이 빠른 편이라, README와 변경 로그는 v0.20.1 같은 버전 표기로 명령 표면과 기본값이 갱신된 시점을 구분한다. v0.20.1은 v0.20.0 뒤의 patch release로, 생성 AGENTS.md marker insertion을 CRLF 환경에서도 안전하게 처리하는 수정 등을 담았다.",
      ],
      subsections: [
        {
          id: "overview-auth",
