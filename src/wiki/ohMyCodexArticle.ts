...
export const ohMyCodexArticle = {
  ...
  infobox: [
    ...
    },
    {
      ...
      value: "v0.19.1",
      valueHref: "https://github.com/Yeachan-Heo/oh-my-codex/releases/tag/v0.19.1",
    },
    { label: "Links", value: "" },
  ],
  sections: [
    {
      ...
      body: [
        ...
        "릴리스 흐름이 빠른 편이라, README와 변경 로그는 v0.19.1 같은 버전 표기로 명령 표면과 기본값이 갱신된 시점을 구분한다. v0.19.1은 Ultragoal/Ralplan terminal-state reliability, direct Team state roots, mission queue execution, dependency hygiene를 다룬 패치 릴리스로 설명된다.",
      ],
      subsections: [
        {
          id: "overview-auth",
