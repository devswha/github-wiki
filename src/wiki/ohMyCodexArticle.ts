...
export const ohMyCodexArticle = {
  ...
  infobox: [
    ...
    },
    {
      ...
      value: "v0.18.17",
      valueHref: "https://github.com/Yeachan-Heo/oh-my-codex/releases/tag/v0.18.17",
    },
    { label: "Links", value: "" },
  ],
  sections: [
    {
      ...
      body: [
        ...
        "릴리스 흐름이 빠른 편이라, README와 변경 로그는 v0.17.0 이후에도 버전 표기로 명령 표면과 기본값이 갱신된 시점을 구분한다. 2026-07-01 v0.18.17은 Ultragoal, Ralplan, planning-gate, Team/MSYS, Windows psmux 쪽 런타임 신뢰성 보강을 패치 릴리스 범위로 잡았다.",
      ],
      subsections: [
        {
          id: "overview-auth",
