  ...
  sections: [
    {
      ...
      body: [
        ...
        "릴리스 흐름이 빠른 편이라, README와 변경 로그는 v0.18.17 같은 버전 표기로 명령 표면과 기본값이 갱신된 시점을 구분한다. 2026-07-01 v0.18.17 전후로는 ultragoal null get_goal loop 복구, MSYS team worker path, ralplan terminal session state 같은 운영 수정이 이어졌다.",
