...
export const gajaeCodeArticle = {
  ...
  summary:
    "gajae-code는 red-claw coding-agent harness로, crisp interviews, resilient plans, tmux-native execution, durable verification을 한 루프로 묶는 실험적 베타 프로젝트다.",
  image: {
  ...
  sections: [
    {
      ...
      body: [
        ...
        "프로젝트 설명은 red-claw coding-agent harness다. 인터뷰, 계획, tmux 기반 실행, 검증을 한 흐름으로 묶고, 이전 OpenAI/Anthropic 코드 하니스 경험에서 남은 반복 루프를 작게 정리한 쪽에 가깝다.",
      ],
      links: [
        {
    ...
    },
    {
      ...
      title: "운영 전제",
      body: [
        "Gajae-Code는 작은 public surface를 유지하려는 coding-agent harness다. 많은 스킬을 기본으로 늘리기보다, 깊은 인터뷰와 계획 비평, 지속 검증 루프를 더 신뢰할 수 있게 만드는 방향을 택한다.",
